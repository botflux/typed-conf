...
describe('integer', function () {
  ...
  describe('optional method', function () {
    it('should be able to update the schema\'s type', function () {
      // Given
      // When
      const optional = integer().optional()
  ...
  it('should be able to be a clear value by default', function () {
    // Given
    // When
    const schema = integer()
